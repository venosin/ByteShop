    ...
    return (
        <div className="max-w-md mx-auto bg-white shadow-lg rounded-lg overflow-hidden border border-gray-200">
            <div className="px-6 py-4">
                ...
                <p className="text-gray-600">
                    <span className="font-semibold">Birthdate:</span> {new Date(employee.birthdate).toLocaleDateString()}
                </p>
                <p className="text-gray-600">
                    <span className="font-semibold">Hire Date:</span> {new Date(employee.hireDate).toLocaleDateString()}
                </p>
                <p className="text-gray-600">
